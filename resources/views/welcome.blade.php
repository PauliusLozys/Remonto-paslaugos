...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <style>
            ...
            button {
                background-color: rgba(112, 177, 155, 0.1);
                border: 1px;
                color: white;
                padding: 10px;
                font-size: 20px;
            ...
            button:hover {
                background-color: rgba(90, 114, 107, 0.8);
            }
        </style>
    </head>
    <body class="antialiased">
        <div class="relative flex items-top justify-center min-h-screen bg-gray-100 dark:bg-gray-900 sm:items-center sm:pt-0" style="background-color: #1a202c">
            @if (Route::has('login'))
